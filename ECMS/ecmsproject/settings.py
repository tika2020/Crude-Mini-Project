"""
Django settings for ecmsproject project.
...
SECRET_KEY = 'django-insecure-h%rypd22pqh-x&(fy*h0=5e$46v!n4+lau*&)262no-%dl^lic'
...
WSGI_APPLICATION = 'ecmsproject.wsgi.application'
